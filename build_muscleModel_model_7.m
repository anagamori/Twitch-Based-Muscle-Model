...
modelParameter.g_e = (parameterMN.I_max- parameterMN.I_th)./(1-modelParameter.U_th); % variable gain for each unit (linear increase in discharge rate upon recruitment to the maximum excitation)

Ur_t = 0.2;
f_t = 1.2;
modelParameter.index_t = find(modelParameter.U_th>=Ur_t);
...
modelParameter.k_e = (f_t*I_half-parameterMN.I_th+modelParameter.lamda.*(parameterMN.I_max-f_t*I_half))./(modelParameter.lamda.*(1-modelParameter.U_th));
