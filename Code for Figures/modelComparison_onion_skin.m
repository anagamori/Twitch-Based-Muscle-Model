...
for i = 1:5
    if i == 1
        condition = 'Model_onion_skin_v2'; %_CTvsPTi';
        Fs = 2000;
        time =0:1/Fs:15;
    ...
    elseif i == 2
        condition = 'Model_onion_skin_N_100_Ur_80_RP_100_constant_gain'; %_CTvsPTi_PR_100';
        Fs = 2000;
        time =0:1/Fs:15;
        data_folder = ['/Users/akira/Documents/Github/Twitch-Based-Muscle-Model/Data/New Model/noTendon/' condition];
        cd(data_folder)
    ...
    elseif i == 3
        condition = 'Model_onion_skin_N_100_Ur_50';
        Fs = 2000;
        time =0:1/Fs:15;
        data_folder = ['/Users/akira/Documents/Github/Twitch-Based-Muscle-Model/Data/New Model/noTendon/' condition];
        cd(data_folder)
