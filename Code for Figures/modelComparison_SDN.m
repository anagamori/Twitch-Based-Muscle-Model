...
for i = 1:8
    ...
    elseif i == 6
        ...
        Fs = 2000;
        time =0:1/Fs:15;
        data_folder = ['/Users/akiranagamori/Documents/Github/Twitch-Based-Muscle-Model/Data/New Model/noTendon/' condition];
        cd(data_folder)
        load('mean_Force')
        load('std_Force')
        load('std_Force_dt')
...
plot(x,x*a_todorov,'LineWidth',1,'Color',[208 28 139]/255)
xlabel('Activation (%)','FontSize',14)
