...
cd('/Users/akiranagamori/Documents/GitHub/Twitch-Based-Muscle-Model/Model Parameters/Model_3_Ur_50_constantT2T');
...
for n = 1:length(index_saturation)
    ...
    if U <= U_th_t(index)
        DR_temp(index) = MDR(index) + lamda(index).*k_e(index).*(U-U_th_new(index));
    else
