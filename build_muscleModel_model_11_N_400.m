...
model_parameter_folder =  '/Users/akiranagamori/Documents/Github/Twitch-Based-Muscle-Model/Model Parameters/Model_11_N_400';
%%
...
cd(code_folder)
FR_half_1 = FR_half';
PDR_temp_1 = 2*FR_half';
idx_all = zeros(1,length(200));
for i = 1:200
    [~,loc] = min(abs(PDR_temp_1-modelParameter.PDR(i)));
    idx_all(i) = loc;
end
index_MU_1 = idx_all; 
CT_temp_1 = CT_sorted(index_MU_1);
...
r = randperm(300,200);
index_MU_2 = sort(r); 
CT_temp_2 = CT_sorted(index_MU_2);
