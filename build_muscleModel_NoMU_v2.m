%==========================================================================
% build_muscleModel_NoMU_v2.m
% Author: Akira Nagamori
% Last update: 3/25/19
% Descriptions:
%   Create a model with 100 motor units in a pool
%   Adjust the maximum force of muscle by keeping the same peak tetanic
%   force of individual motor units from the base model
...
model_parameter_folder =  '/Users/akiranagamori/Documents/Github/Twitch-Based-Muscle-Model/Model Parameters/Model_N_100_adjustedF0';
...
PTi_temp = P_MU./sum(P_MU)*modelParameter.F0; % peak tetanic force for individual units

%% Update model parameters
modelParameter.N_MU = 100; % number of motor units
modelParameter.i_MU = 1:modelParameter.N_MU; % index for motor units
PTi = PTi_temp(1:300/modelParameter.N_MU:300);
modelParameter.F0 = sum(PTi);
%% Fractional PSCA
