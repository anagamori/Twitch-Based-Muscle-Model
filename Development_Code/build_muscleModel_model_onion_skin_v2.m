...
modelParameter.MDR = ones(modelParameter.N_MU,1)*8; %modelParameter.FR_half/2;

f_PDR = fit([1 modelParameter.N_MU]',[35 25]','exp1');
coeffs_f_PDR = coeffvalues(f_PDR);
PDR = coeffs_f_PDR(1)*exp(coeffs_f_PDR(2)*modelParameter.i_MU);
modelParameter.PDR = PDR;
%modelParameter.g_e = (PDR(end) - 8)/(1-U_th(end));
...
index_1 = find(f_t*modelParameter.FR_half<=modelParameter.MDR);
modelParameter.index_saturation(index_1) = [];
% modelParameter.U_th_t(index_1) = 0;
% 
index_2 = find(f_t*modelParameter.FR_half(modelParameter.index_saturation)>=PDR(modelParameter.index_saturation));
modelParameter.index_saturation(index_2) = [];
%modelParameter.U_th_t(index_2) = 1;
% modelParameter.U_th_t(index_2) = 0;
...
cd(model_parameter_folder)
save('modelParameter_onion_skin_v4','modelParameter')
cd(code_folder)
