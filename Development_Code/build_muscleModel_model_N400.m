...
modelParameter.index_slow = 147*2;
%% Model parameters for activation-frequency relationship
cd(model_parameter_folder )
load('pool_parameter_matrix')
cd(code_folder)
parameter_Matrix_temp = [];
for i = 1:200
    parameter_Matrix_temp = [parameter_Matrix_temp;parameter_Matrix(i,:);parameter_Matrix(i,:)];
end
modelParameter.parameterMatrix = parameter_Matrix_temp;
...
FR_half_temp = [];
for i = 1:200
    FR_half_temp = [FR_half_temp;FR_half(i);FR_half(i)];
end
modelParameter.FR_half = FR_half_temp;
...
cd(model_parameter_folder)
save('modelParameter_N_400','modelParameter')
cd(code_folder)
